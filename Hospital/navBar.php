        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
               <a class="dropdown-item" href="#">AI Engine for Triage Notes</a>
              <a class="dropdown-item" href="/incomingPatients.php">Incoming Patients Creator</a>
              <a class="dropdown-item" href="/monitor.php">Bed Monitor</a>
